<?php /* LFS — Lusaka Fitness Squad — pages/about.php */ ?>

<!-- ══════════════════════════════════════════════
     1. PAGE HERO
     ══════════════════════════════════════════════ -->
<section class="relative overflow-hidden bg-black text-white" style="min-height:520px">
  ...
  <div class="relative z-10 px-6 md:px-16 py-24 md:py-32 max-w-4xl">
    ...
    <h1 class="font-['Bebas_Neue'] text-5xl sm:text-6xl lg:text-7xl leading-tight text-white mt-6 animate-fadeUp"
      ...
      About Lusaka<br>Fitness Squad
    </h1>

    <p class="mt-5 text-white/70 text-base md:text-lg font-light leading-relaxed max-w-2xl animate-fadeUp"
      ...
      <div class="relative flex gap-6 md:gap-10 pb-10 group" data-reveal data-reveal-delay="<?= ($i % 3) + 1 ?>">
        ...
        <div class="flex-1 pb-2">
          <div class="flex items-center gap-3 mb-2">
            ...
            <span class="font-['Bebas_Neue'] text-3xl md:text-4xl" style="color:<?= $m['color'] ?>"><?= htmlspecialchars($m['year']) ?></span>
          </div>
          <h3 class="font-['Bebas_Neue'] text-xl tracking-wide text-white mb-1"><?= htmlspecialchars($m['title']) ?></h3>
          <p class="text-white/45 text-sm leading-relaxed"><?= htmlspecialchars($m['body']) ?></p>
        </div>
...
<section id="mission" class="py-20 px-6 md:px-16 text-white relative overflow-hidden"
  ...
  <div class="relative z-10 grid md:grid-cols-2 gap-12 items-center mt-10 max-w-5xl mx-auto">
    ...
    <div class="grid grid-cols-1 gap-4" data-reveal="right">
      <?php foreach ($missionPillars as $p): ?>
      <div class="flex items-start gap-4 p-4 rounded border transition-colors"
        ...
        <div>
          <div class="font-['Bebas_Neue'] text-lg tracking-wide text-white"><?= htmlspecialchars($p['label']) ?></div>
          <p class="text-white/45 text-sm leading-relaxed mt-0.5"><?= htmlspecialchars($p['body']) ?></p>
        </div>
      </div>
      <?php endforeach; ?>
    </div>
...
<section id="values" class="py-20 px-6 md:px-16 bg-lfs-off-white">
  ...
  <div class="max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mt-10">
    ...
    <div class="bg-white p-6 rounded border-t-4 transition-all hover:-translate-y-1 hover:shadow-lg"
      ...
      <h3 class="font-['Bebas_Neue'] text-2xl tracking-wide mb-2"><?= htmlspecialchars($v['title']) ?></h3>
      <p class="text-[#6b6b6b] text-sm leading-relaxed"><?= htmlspecialchars($v['body']) ?></p>
    </div>
    <?php endforeach; ?>
  </div>
...
<section id="leadership" class="py-20 px-6 md:px-16 bg-lfs-warm-white">
  ...
  <div class="max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-10">
    <?php foreach ($management as $i => $person): ?>
    <div class="bg-white rounded overflow-hidden border-b-4 transition-all hover:-translate-y-1 hover:shadow-lg"
      ...
      <div class="h-52 overflow-hidden bg-lfs-off-white">
        <img src="<?= htmlspecialchars($person['image']) ?>"
          alt="<?= htmlspecialchars($person['name']) ?> — <?= htmlspecialchars($person['role']) ?>"
      ...
      <!-- Body -->
      <div class="p-4">
        <div class="text-[0.6rem] font-semibold tracking-widest uppercase mb-1" style="color:var(--green)"><?= htmlspecialchars($person['role']) ?></div>
        <h3 class="font-['Bebas_Neue'] text-xl leading-tight mb-2"><?= htmlspecialchars($person['name']) ?></h3>
        <p class="text-[#6b6b6b] text-xs leading-relaxed line-clamp-3"><?= htmlspecialchars($person['bio']) ?></p>
      </div>
    </div>
    <?php endforeach; ?>
  </div>
      ...
      <div class="p-6 flex flex-col items-start gap-3 transition-colors hover:bg-white/5"
        ...
        <div>
          <div class="font-['Bebas_Neue'] text-4xl md:text-5xl text-white leading-none"
            data-count="<?= htmlspecialchars($s['num']) ?>"><?= htmlspecialchars($s['num']) ?></div>
...
<section id="join" class="py-20 px-6 md:px-16 text-white relative overflow-hidden"
  ...
  <div class="relative z-10 max-w-3xl mx-auto text-center" data-reveal>
    ...
    <div class="flex flex-wrap gap-4 justify-center mt-8">
      ...
      <a href="/contact" class="btn btn-outline text-base px-8 py-4">
